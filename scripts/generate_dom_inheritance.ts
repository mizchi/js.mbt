...
async function main() {
  ...
  if (elementMethods) {
    const outputPath = "src/browser/dom/element_generated.mbt";
...
`;
  ...
  if (htmlElementMethods) {
    const outputPath = "src/browser/dom/html_element_generated.mbt";
    const content = `// This file is auto-generated. Do not edit manually.
// Generated by scripts/generate_dom_inheritance.ts
...
`;
  ...
  if (documentMethods) {
    const outputPath = "src/browser/dom/document_generated.mbt";
    const content = `// This file is auto-generated. Do not edit manually.
// Generated by scripts/generate_dom_inheritance.ts
...
`;
  ...
  await Deno.writeTextFile(
    "src/browser/dom/html_elements_generated.mbt",
...
`;
  ...
  await Deno.writeTextFile(
    "src/browser/dom/svg_elements_generated.mbt",
