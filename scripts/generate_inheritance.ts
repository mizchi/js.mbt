...
`;
      ...
      console.log(`  ✅ Generated: ${config.outputDir}/${snakeCaseName}_generated.mbt`);
    }
  }
...
`;
    ...
    await writeFile(
      join(projectRoot, config.outputDir, "html_elements_generated.mbt"),
      allElementsContent,
      "utf-8"
    );
    console.log(`  ✅ Generated: ${config.outputDir}/html_elements_generated.mbt`);
  }
...
`;
    ...
    await writeFile(
      join(projectRoot, config.outputDir, "svg_elements_generated.mbt"),
      allSvgElementsContent,
      "utf-8"
    );
    console.log(`  ✅ Generated: ${config.outputDir}/svg_elements_generated.mbt`);
  }
}
