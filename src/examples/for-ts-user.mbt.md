...
test "error handling" {
  ...
  let result1 = try {
    ...
    Failure(msg) => {
      inspect(msg, content="/Users/mizchi/mizchi/js.mbt/src/examples/for-ts-user.mbt.md:229:7-229:31 FAILED: Division by zero")
      -1
    }
    _ => -1
  }
...
test "custom errors" {
  let risky_operation = fn() -> Int raise MyError {
    raise MyError
  }
